  ...
  return (
    <main className="min-h-screen bg-black text-white relative overflow-hidden">
        ...
        <div className="container mx-auto max-w-7xl">
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-12">
            ...
            <div className="lg:col-span-2 space-y-16">
              ...
              >
                <div className="absolute -inset-0.5 bg-gradient-to-r from-blue-600 to-purple-600 rounded-2xl opacity-20 group-hover:opacity-30 blur transition-opacity" />
                ...
                >
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    {service.benefits.map((benefit, index) => (
                      ...
                      >
                        <div className="absolute -inset-0.5 bg-gradient-to-r from-blue-600 to-cyan-600 rounded-xl opacity-0 group-hover:opacity-20 blur transition-opacity" />
            ...
            <div className="lg:col-span-1">
              <div className="sticky top-24 space-y-8">
                ...
                <motion.div
                  ...
                  className="relative group"
                >
                  <div className="absolute -inset-1 bg-gradient-to-r from-blue-600 via-purple-600 to-pink-600 rounded-2xl opacity-50 group-hover:opacity-75 blur-lg transition-opacity" />
                ...
                {service.useCases && service.useCases.length > 0 && (
                  <motion.div
                    ...
                    className="relative group"
                  >
                    <div className="absolute -inset-0.5 bg-gradient-to-r from-cyan-600 to-blue-600 rounded-2xl opacity-20 group-hover:opacity-30 blur transition-opacity" />
                    <div className="relative bg-gray-900/80 backdrop-blur-sm rounded-2xl border border-gray-800 p-6">
                      ...
                      <ul className="space-y-3">
                        {service.useCases.map((useCase, index) => (
                          ...
                          >
                            <span className="text-sm font-bold text-cyan-400 mt-0.5">{index + 1}.</span>
                ...
                <motion.div
                  ...
                  className="relative group"
                >
                  <div className="absolute -inset-1 bg-gradient-to-r from-blue-600 to-purple-600 rounded-2xl opacity-50 group-hover:opacity-75 blur-lg transition-opacity" />
      ...
      {service.images && service.images.length > 0 && (
        <section className="relative py-20 px-6 bg-gradient-to-b from-black via-gray-950 to-black">
          <div className="container mx-auto max-w-7xl">
            <motion.div
              initial={{ opacity: 0, y: 40 }}
              whileInView={{ opacity: 1, y: 0 }}
              ...
              transition={{ duration: 0.8 }}
            >
              <h2 className="font-display text-3xl md:text-4xl font-bold text-white mb-12 text-center bg-gradient-to-r from-blue-400 to-purple-400 bg-clip-text text-transparent">
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                {service.images.map((image, index) => (
                  <motion.div
                    ...
                    className="relative group"
                  >
                    <div className="absolute -inset-1 bg-gradient-to-r from-blue-600 to-purple-600 rounded-xl opacity-0 group-hover:opacity-50 blur transition-opacity" />
