...
export default function TechnologiesPage() {
  return (
    <>
      <Head
        title="Technologies - AI/ML, Cloud, Cybersecurity & More | technorealmtr.com"
        ...
        ogTitle="Technologies - AI/ML, Cloud, Cybersecurity & More | technorealmtr.com"
        ...
        twitterTitle="Technologies - AI/ML, Cloud, Cybersecurity & More | technorealmtr.com"
